...
export const Pharmabookingdone = () => {
  return (
    <>
    <nav className='pharmabookingdone_navbar_doctorcase'>
        <div className='pharmabookingdone_navbar_logo_doctorcase'>
        <img src={Weblogo} alt="logo_doctorcase" />
        </div>

        <ul className='pharmabookingdone_nav_links_doctorcase'>
            <li className='pharmabookingdone_list_item_doctorcase'>Dooper At Home</li>
            <li className='pharmabookingdone_list_item_doctorcase'>Lab Tesst </li>
            <li className='pharmabookingdone_list_item_doctorcase'>Our Network < FaCaretDown/></li>
            <li className='pharmabookingdone_list_item_doctorcase'>About Us</li>
            <li className='pharmabookingdone_list_item_doctorcase'>Contact Us</li>
            <li className='pharmabookingdone_list_item_doctorcase'>Join Us With <FaCaretDown/></li>
            <li className='pharmabookingdone_list_item_1_dhacase'><img src={profile} alt="" className='pharmabookingdone_jaydoctor_profile'/>Jaydeep Sakhiya <FaCaretDown/></li>
            <li className='pharmabookingdone_list_item_1_doctorcase'><FaBell className='pharmabookingdone_icons_bell_doctorcase'/></li>
            <li className='pharmabookingdone_list_item_1_doctorcase_2'>< BsTelephone className='pharmabookingdone_phone_icon_doctorcase'/></li>
        </ul>
                    ...
                    <div className='pharmabookingdone_doctor_case_detail_symptom'>
                        <div className='pharmabookingdone_doctor_case_deatil_symptom_1'>
                            <div className='pharmabookingdone_doctor_case_detail_symptom_left'>
                                <div className='pharmabookingdone_doctor_case_detail_symptom_left_1'>Medicine 1</div>
                                <div className='pharmabookingdone_doctor_case_detail_symptom_left_1'>Medicine 2</div>
                                <div className='pharmabookingdone_doctor_case_detail_symptom_left_1'>Medicine 3</div>
                            </div>
...
export default Pharmabookingdone
