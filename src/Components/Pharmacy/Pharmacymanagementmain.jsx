  ...
  return (
    ...
    <div className='bg-[#F5F6F7] w-[100%] pt-[20px]'>
            <div className='flex justify-between items-center ml-[70px] mr-[70px] '>
                ...
                <h2 className='font-bold font-montserrat text-[#1A1C1F] flex justify-around items-center text-[22px]'><Link to={""}><PiArrowLeftFill className='pr-[10px] text-[#1A1C1F] text-center items-center text-[30px]'/></Link>Pharmacy Management</h2>
                </div>
                <div className='flex justify-end items-center'>
                <Link to={"/pharmacymanagement"} className="Link">
                        <button className='h-[36px] w-[137px] bg-[#FCE6EC] rounded-[8px] border-none mr-[5px] text-[#E40443] font-semibold text-[14px] font-montserrat flex justify-center items-center'>Dashboard</button>
                    </Link>
                    <Link to={"/pharmacyrequest"} className="Link">
                        <button className='h-[36px] w-[137px] bg-[#FCE6EC] rounded-[8px] border-none mr-[5px] text-[#E40443] font-semibold text-[14px] font-montserrat flex justify-center items-center'>Pharmacy Request</button>
                    </Link>
                    <Link to={"/addpharma"} className="Link">
                        <button className='h-[36px] w-[137px] bg-[#FCE6EC] rounded-[8px] border-none ml-[5px] text-[#E40443] font-semibold text-[14px] font-montserrat flex justify-center items-center'><IoMdAdd className='w-[14px] h-[14px] mr-[10px]'/>Add Pharmacy</button>
                    </Link>
                </div>
            </div>
