                ...
                <div className='flex justify-center border-b-[1px] border-b-solid border-b-[#E4E4E4]'>
                    ...
                    <div className='w-[284px] mt-[10px] ml-[20px] mb-[10px]'>
                        <div className='flex justify-between items-center '>
                            ...
                            <div className='bookingrequestpharmacy_bookingrequest_pharma_btn_1'><button className='rounded-[24px] border-none h-[22px] w-[73px] bg-[#F4F4F4] text-[#41B078] text-[10px] font-medium font-montserrat'>Delivered</button></div>
