...
export const Completedaddquotation = () => {
  ...
  */}
                ...
                <div className='bg-[white] mr-[70px] w-[380px] h-[200px] rounded-[16px] mb-[20px]'>
                    <div className='rounded-[16px] bg-[white]'>
                        ...
                        <div className=''>
                            <ul className='flex justify-between mr-[20px] ml-[20px] pt-[5px] pb-[5px]'>
                                <li className='list-none text-[#8D98A4] text-[14px] font-medium font-montserrat '>Subtotal</li>
                                <li className='list-none text-[#1A1C1F] text-[14px] font-medium font-montserrat'>Rs 600</li>
                            </ul>
                        </div>
                        <div className=''>
                            <ul className='flex justify-between mr-[20px] ml-[20px] pt-[5px] pb-[5px] border-b-[1px] border-b-solid border-b-[#E3E6E8]'>
