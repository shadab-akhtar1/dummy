...
export const Earninglab = () => {
  return (
    ...
    <div className='earning_profile_documnet_labdetailedit_pharma_edit_basic'>
        ...
        <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_basic_base_lab'>
            <Link to={"/earning" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_lab'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_basic_2_lab'>All</div>
            </Link>
            <Link to={"/earningdha" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_lab'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_document_basic_lab'>DHA</div>
            </Link>
            <Link to={"/earningdoctor" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_lab'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_1_lab'>Doctor</div>
            </Link>
            <Link to={"/earningpharmacy" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_lab'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_2_lab'>Pharmacy</div>
            </Link>
            
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_3_lab'>Lab</div>
      ...
      <div className='earning_container_3'>
        <div className='earning_container_3_1'>
            ...
            <Link to={"/earninglabhistory"} className='earning_link'>
