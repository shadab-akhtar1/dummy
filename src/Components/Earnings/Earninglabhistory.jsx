...
export const Earninglabhistory = () => {
  return (
    <>
    <div><Navbars/></div>
    <div className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_basic'>
        ...
        <div className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_heading2_basic_base_labhistory'>
            <Link to={"/earning" } className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_document_basic_labhistory'>
            <div className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_heading2_basic_2_labhistory'>All</div>
            </Link>
            <Link to={"/earningdha" } className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_document_basic_labhistory'>
            <div className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_heading2_document_basic_labhistory'>DHA</div>
            </Link>
            <Link to={"/earningdoctor" } className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_document_basic_labhistory'>
            <div className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_1_labhistory'>Doctor</div>
            </Link>
            <Link to={"/earningpharmacy" } className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_document_basic_labhistory'>
            <div className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_2_labhistory'>Pharmacy</div>
            </Link>
            
            <div className='earninghistory_earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_3_labhistory'>Lab</div>
      ...
      <div className='earninghistory_earning_container_3'>
        <div className='earninghistory_earning_container_3_1'>
          <Link to={"/earninglab"} className='earning_link'>
...
export default Earninglabhistory