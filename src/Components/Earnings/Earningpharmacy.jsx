  ...
  return (
    ...
    <div className='w-[100%] bg-[#F4F4F4] pt-[20px]'>
        ...
        <Link to={"/earning" } className='no-underline'>
            ...
            <div className='mt-[20px] mr-[20px] border-b-[2px] border-b-solid border-b-[#E40443]  text-[#1A1C1F] text-[16px] font-medium font-montserrat cursor-pointer'>Pharmacy</div>
