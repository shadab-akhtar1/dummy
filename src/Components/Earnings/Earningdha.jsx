...
export const Earningdha = () => {
  return (
    ...
    <div className='earning_profile_documnet_labdetailedit_pharma_edit_basic'>
        <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading_basic'><h2><Link to={"/earning"} className='earning_profile_documnet_labdetailedit_link_pharma_detailsedit_head_basic'><PiArrowLeftFill className='earning_profile_documnet_labdetailedit_pharma_arrow_edit_basic'/></Link>My Earnings</h2></div>
        <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_basic_base_dha'>
            <Link to={"/earning" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_dha'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_basic_2_dha'>All</div>
            </Link>
            
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_document_basic_dha'>DHA</div>
            <Link to={"/earningdoctor" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_dha'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_dha'>Doctor</div>
            </Link>
            <Link to={"/earningpharmacy" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_dha'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_dha'>Pharmacy</div>
            </Link>
            <Link to={"/earninglab" } className='earning_profile_documnet_labdetailedit_pharma_edit_document_basic_dha'>
            <div className='earning_profile_documnet_labdetailedit_pharma_edit_heading2_info_basic_dha'>Lab</div>
            </Link>
        </div>
