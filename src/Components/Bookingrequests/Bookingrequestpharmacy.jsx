  ...
  return (
    ...
    <div className='bg-[#F4F4F4] w-[100%] '>
        ...
        <div className='flex justify-between items-center ml-[70px] mr-[70px] border-b-[1px] border-b-solid border-b-[#E1E5E8] mt-[20px]'>
            ...
            <Link to={"/bookingrequesdha"} className='bookingrequest_medicine_link'>
                ...
                <div className='flex justify-center border-b-[1px] border-b-solid border-b-[#E4E4E4]'>
                    ...
                    <div className='w-[284px] mt-[10px] ml-[20px] mb-[10px]'>
                        <div className='flex justify-between items-center '>
                            ...
                            <div className='bookingrequestpharmacy_bookingrequest_pharma_btn_1'><button className='rounded-[24px] border-none h-[22px] w-[134px] bg-[#F4F4F4] text-[#7C67FB] text-[10px] font-medium font-montserrat'>Quotation Requested</button></div>
