    ...
    <div className='bg-[#F4F4F4] pt-[20px]'>
        <div className='flex justify-between items-center  ml-[70px] mr-[70px]'>
            ...
            <div className=' pt-[1px] '>
                <h2 className='flex justify-start font-bold font-montserrat text-[22px]'><Link to={"/bookingdhacase"} className='dhaassign_profile_documnet_labdetailedit_link_pharma_detailsedit_head_basic'><PiArrowLeftFill className='text-[#1A1C1F] text-center  pr-[10px] text-[30px]'/></Link>Choose Doctor</h2>
            </div>
