    ...
    <div className='dhaassign_container_2'>
        ...
        <div className='dhaassign_container_2_2'>
            <div className='dhaassign_container_2_2_first'tabIndex={1}>
                ...
                <div className='dhaassign_container_2_2_first_down_main'>
            ...
            <div className='dhaassign_container_2_2_first'tabIndex={1}>
                ...
                <div className='dhaassign_container_2_2_first_down_main'>
                    <div className='assigndoctor_dhaassign_container_2_2_first_down_1_left'>
                    <div className='dhaassign_container_2_2_first_down_1'>Devon Lane</div>
                    <div className='dhaassign_container_2_2_first_down_2'>Physiotherapist</div>
                    </div>
                </div>
            ...
            <div className='dhaassign_container_2_2_first'tabIndex={1}>
                ...
                <div className='dhaassign_container_2_2_first_down_main'>
                    <div className='assigndoctor_dhaassign_container_2_2_first_down_1_left'>
                    <div className='dhaassign_container_2_2_first_down_1'>Floyd Miles</div>
                    <div className='dhaassign_container_2_2_first_down_2'>Physiotherapist</div>
                    </div>
                </div>
