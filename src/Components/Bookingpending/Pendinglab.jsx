  ...
  return (
    ...
    <div className='bg-[#F4F4F4] w-[100%] '>
        ...
        <div className='flex justify-between items-center ml-[70px] mr-[70px] border-b-[1px] border-b-solid border-b-[#E1E5E8] mt-[20px]'>
            ...
            <Link to={"/bookingpendinglab"} className='bookingrequest_medicine_link'>
            ...
            <div className='ml-[20px] text-[#1A1C1F] text-[16px] font-medium font-montserrat border-b-[2px] border-b-solid border-b-[#E40443]'>Lab</div>
        ...
        <div className='ml-[70px] mt-[30px] mr-[70px] flex flex-wrap gap-[38px]'>
            <Link to={"/pendinglabdetail"} className='pahrma_boking_link'>
