  ...
  return (
    ...
    <div className='bookingrequest_pharmacy_management_container'>
        ...
        <div className='pendinglab_bookingrequest_pharmacy_management_container_2'>
            ...
            <Link to={"/bookingpendingdha"} className='pendinglab_bookingrequest_medicine_link'>
            <div className='pendinglab_bookingrequest_pharmacy_management_container_2_p_1'>DHA</div>
            </Link>
            <Link to={"/pendingdoctor"} className='pendinglab_bookingrequest_medicine_link'>
            <div className='pendinglab_bookingrequest_pharmacy_management_container_2_p_2'>Doctor</div>
            </Link>
            <Link to={"/pendingpharmacy"} className='pendinglab_bookingrequest_medicine_link'>
        ...
        <div className='bookingrequest_pharmacy_management_container_3'>
                ...
                <div className='bookingrequest_pharmacy_management_container_3_1_up'>
                    <div className='bookingrequest_pharmacy_management_container_3_1_up_box'>
                        ...
                        <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right'>
                            <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right_1'><PiCalendarBlankLight className='pendinglab_calen'/>13 June, 2023</div>
                            <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right_2'><CiClock2 className='pendinglab_clock'/>09:00AM</div>
                        </div>
                    </div>
            ...
            <Link to={"/pendinglabdetail"} className='bookingrequest_pahrma_boking_link'>
