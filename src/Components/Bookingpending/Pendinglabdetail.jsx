        ...
        <div className='bookingcase_middle_container_heading_1_dha_case_details'>
          ...
          <h2># 123456</h2>
            ...
            <div className='bookingcase_third_container_dha_case_details'>
                <div className='bookingcase_third_container_left_dha_case_details_pendinglabdetail'>
                    ...
                    <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para'>
                        <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_left'>
                        
                            <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_container_1'><div><IoCheckmark className='pharmabooking_doctor_check_mark' /></div></div>
                            
                            <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_container_2'>02</div>
                            <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_container_3'>03</div>
                            
                            
                    
                        </div>
                       
                        <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_right'>

                        <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_right_5'>
                                <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_right_2_up_1'>
                                    <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_content_2'>
                        ...
                        <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_right_5'>
                                <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_right_2_up'>
                                    <div className='lab_pendinglabdetail_pharmabooking_doctor_case_detail_para_content_2'>
