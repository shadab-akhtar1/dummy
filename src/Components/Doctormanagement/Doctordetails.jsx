    ...
    <div className='bg-[#F5F6F7] pt-[20px]'>
      <div className='flex justify-between items-center ml-[70px] mr-[70px] h-[68px]'>
        <div className='flex justify-start items-center'>
          <h2 className='font-bold font-montserrat flex justify-around items-center text-[#1A1C1F] text-[22px]'> <Link to={"/doctorrequests"} className='no-underline'>< PiArrowLeftFill className='text-[#1A1C1F] text-center  pr-[10px] text-[30px]'/></Link>Doctor Details</h2>
        </div>
        <div className='flex justify-end items-center'>
          <Link to={"/doctordetailsbasic"} className='no-underline'>
          ...
          <Link to={"/blockdoctor"} className='no-underline'>
