...
export const Doctordetailsbasic = () => {
  ...
  return (
    ...
    <div className='w-[100%] mt-[10px] bg-[#F4F4F4]'>
        ...
        <div className='ml-[70px] pt-[20px] '><h2 className='text-[22px] font-montserrat font-bold flex justify-start items-center'><Link to={"/doctordetails"} className='link_detailsedit_head'><PiArrowLeftFill className='text-[#1A1C1F] text-center pt-[3px] pr-[10px] text-[30px]'/></Link>Edit DHA Details</h2></div>
                ...
                <div className="bg-[#FFFFFF] w-[450px] rounded-[16px] p-[32px] ">
                    <div className='gap-[24px]'>
                        ...
                        <form action="" className='mt-[5px]'>
                            ...
                            <div className='grid items-center mb-[10px]'>
                                <label className='text-[12px] font-medium font-montserrat text-[#8D98A4] mb-[5px]'>Pharmacy Address</label>
                            ...
                            <div className='grid items-center mb-[10px]'>
                                <label className='text-[12px] font-medium font-montserrat text-[#8D98A4] mb-[5px]'>Speciality</label>
                                <input type="text" className='text-[#1A1C1F] border-[1px] border-solid border-[#EEF0F3] rounded-[6px] h-[40px] mb-[10px] flex justify-start items-center font-montserrat outline-none' placeholder='Dentist'/>
                            </div>
                        </form>
        ...
        <div className='bg-[#FFFFFF] w-[450px] rounded-[16px] p-[32px] '>
            <div className='gap-[24px] '>
                ...
                <div className='mb-[20px] grid justify-center items-center '>
                    ...
                    <div className='mb-[20px] grid justify-center items-center'>
                        <label className='text-[12px] font-medium font-montserrat text-[#8D98A4] mb-[5px]'>Lab RMC Medical Counsel Certificate</label> 
                        <input type="file" id='document_form' className='hidden w-[400px]'/>
                        <label for="document_form" className='w-[400px] text-[#EEF0F3] border-[1px] border-solid border-[#EEF0F3] rounded-[6px] h-[40px] flex justify-between items-center'>
