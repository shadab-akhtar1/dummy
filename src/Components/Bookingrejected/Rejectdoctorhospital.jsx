...
import './Rejectdoctorhospital.css';
...
export const Rejectdoctorhospital = () => {
  ...
  return (
    ...
    <div className='bookingrequest_pharmacy_management_container'>
        ...
        <div className='bookingrequest_pharmacy_management_container_2_pendingdoctor'>
            ...
            <Link to={"/rejectdhahospital"} className='bookingrequest_medicine_link_pendingdoctor'>
            ...
            <Link to={"/rejectpharmacyhospital"} className='bookingrequest_medicine_link_pendingdoctor'>
            <div className='bookingrequest_pharmacy_management_container_2_p_3_pendingdoctor'>Pharmacy</div>
            </Link>
            <Link to={"/rejectlabhospital"} className='bookingrequest_medicine_link_pendingdoctor'>
        ...
        <div className='bookingrequest_pharmacy_management_container_4'>
            ...
            {isActive &&(
              <div className='bookingpending_dropdown_content_drop'>
                <Link to={"/rejectdoctorhospital1"} className='bookingpending_dropdown_link'>
                ...
                <div className='bookingrequest_pharmacy_management_container_3_1_up'>
                    <div className='bookingrequest_pharmacy_management_container_3_1_up_box'>
                        ...
                        <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right'>
                            <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right_1'><PiCalendarBlankLight className='rejectdoctorhospital_calen'/>13 June, 2023</div>
                            <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right_2'><CiClock2 className='rejectdoctorhospital_clock'/>09:00AM</div>
                        </div>
                    </div>
                ...
                <div className='bookingrequest_pharmacy_management_container_3_1_down'>
                    ...
                    <div className='bookingrequest_pharmacy_management_container_3_1_down_right'>
                        <div className='bookingrequest_pharmacy_management_container_3_1_down_right_up'>
                            ...
                            <div className='rejecthospital_doctor_hospital_pendingdha_card_2_up'><button>Rejected</button></div>
                        </div>
                        
                        <div className='rejecthospital_doctor_hospital_pendingdoctor_bookingrequest_lab_card_2_left'>
                        Age : 32 | Gender: Male | Blood Group: O+
                        </div>
                        
                        <div className='rejecthospital_doctor_hospital_pendingdoctor_bookingrequest_lab_card_2_right'>
...
export default Rejectdoctorhospital