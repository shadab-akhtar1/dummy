...
import './Rejectdoctorhospital1.css';
  ...
  return (
    ...
    <div className='bookingrequest_pharmacy_management_container'>
        ...
        <div className='bookingrequest_pharmacy_management_container_2_pendingdoctor_hospital'>
            ...
            <Link to={"/rejectdhahospital"} className='bookingrequest_medicine_link_pendingdoctor_hospital'>
            ...
            <Link to={"/rejectpharmacyhospital"} className='bookingrequest_medicine_link_pendingdoctor_hospital'>
            <div className='bookingrequest_pharmacy_management_container_2_p_3_pendingdoctor_hospital'>Pharmacy</div>
            </Link>
            <Link to={"/rejectlabhospital"} className='bookingrequest_medicine_link_pendingdoctor_hospital'>
        ...
        <div className='bookingrequest_pharmacy_management_container_4'>
            ...
            {isActive &&(
              <div className='bookingpending_dropdown_content_drop'>
                <Link to={"/rejectdoctorhospital"} className='bookingpending_dropdown_link'>
                ...
                <div className='bookingrequest_pharmacy_management_container_3_1_up'>
                    <div className='bookingrequest_pharmacy_management_container_3_1_up_box'>
                        ...
                        <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right'>
                            <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right_1'><PiCalendarBlankLight className='rejectdoctorhospital1_calen'/>13 June, 2023</div>
                            <div className='bookingrequest_pharmacy_management_container_3_1_up_box_right_2'><CiClock2 className='rejectdoctorhospital1_clock'/>09:00AM</div>
                        </div>
                    </div>
                ...
                <div className='bookingrequest_pharmacy_management_container_3_1_down'>
                    ...
                    <div className='bookingrequest_pharmacy_management_container_3_1_down_right'>
                        <div className='bookingrequest_pharmacy_management_container_3_1_down_right_up'>
                            ...
                            <div className='rejectdoctorhospital1_pendingdha_card_2_up_doctorhospital1'><button>Rejected</button></div>
                        </div>
