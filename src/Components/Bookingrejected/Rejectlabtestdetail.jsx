                    ...
                    <div className=' mt-[10px] flex gap-[20px] ml-[20px] '>
                            ...
                            <div className=' flex justify-center items-center '>
                                    <div className='grid justify-start mb-[20px]'>
                                        ...
                                        <div className=' '><button className='text-[#F50202] bg-[#FDC2C2] font-medium font-montserrat text-[14px] flex justify-center items-center rounded-[8px] w-[70px] '>Rejected</button></div>
