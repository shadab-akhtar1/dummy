...
export const Labbookingstarted = () => {
  ...
  */}
                        ...
                        <div className='  flex gap-[20px] '>
                            <div className='flex flex-col items-center'>
                                <div className='w-[32px] h-[32px] bg-[#E40443] text-[white] rounded-[40px] p-[12px] gap-[8px] flex justify-center items-center text-[12px]'>02</div>
                                <div className='h-full border border-dashed border-[#EEF0F3]'></div>
                            </div>
                            <Link to="">
                                <div className=' grid justify-center items-center '>
                                    ...
                                    <div className='flex justify-start items-center mb-[20px]'>
                                      <div className='bg-[#F5F6F7] border-none rounded-[8px] h-[70px] w-[80px] grid justify-center items-center ml-[10px]'><span className='text-[#1A1C1F] text-[24px] font-medium font-montserrat'>32</span ><span className='text-[#1A1C1F] text-[12px] font-medium font-montserrat flex justify-center items-center'>MM</span></div>
                                      <div className='bg-[#F5F6F7] border-none rounded-[8px] h-[70px] w-[80px] grid justify-center items-center ml-[20px]'><span className='labstarted_span'>23</span> <span className='text-[#1A1C1F] text-[12px] font-medium font-montserrat flex justify-center items-center'>SS</span></div>
                                      <div className='bg-[#F5F6F7] border-none rounded-[8px] h-[70px] w-[80px] grid justify-center items-center ml-[20px]'><span className='labstarted_span'>01</span> <span className='text-[#1A1C1F] text-[12px] font-medium font-montserrat flex justify-center items-center'>MS</span></div>
                                    </div>
                                </div>
                                </Link>
