    ...
    <div className='w-[100%]'><Navbar/></div>
        <div className='bg-[#F5F6F7] w-[100%] pt-[20px]'>
            <div className='  ml-[70px] mr-[70px]'>
                ...
                <h2 className='font-bold font-montserrat text-[#1A1C1F flex justify-start items-center text-[22px]'> <Link to={"/dhamanagement"}><PiArrowLeftFill className='text-[#1A1C1F] text-center  pr-[10px] text-[30px] '/></Link>DHA Requests</h2>
                </div>
