        ...
        <div className='adddha_bank'>
            ...
            <form action="" className='adddha_form'>
                ...
                <div className='adddha_form_fill_bank'>
                    ...
                    <div className='adddha_form_fill_bank_div'><label className='adddha_form_fill_labi'>Upload Bank Statement/cancel Cheque</label></div><br />
                    <input type="file" id="adddha_file"className='adddha_form_fill_inp_bank_3' />
                    <label for="adddha_file" className='adddha_file_up_bank'><i><RiUploadCloudLine/></i>Upload File</label>
                </div>
                <Link to={"/adddhasuccess"} className='adddhabank_link'> 
                <button className='adddha_btn_bank'>Upload</button>
                </Link>
